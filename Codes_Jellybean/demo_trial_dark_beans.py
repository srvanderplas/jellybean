...
# mask on the image
    ...
    cv2.imwrite(r"D:\Jellybean\Relevant\Test_Images\cropped_eq_sq.png",stack_img)
    # histogram
...
#     cv2.imwrite(r"D:\Jellybean\Relevant\Test_Images\cc.png",img2)
    ...
    img_mask_col_ns = flood_fill(img_mask_col_ns, (0, 0,0),255)
