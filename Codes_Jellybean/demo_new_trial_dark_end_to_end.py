...
# path = r"D:\Jellybean\Relevant\jellybean_data-master\aw_root_beer\DSC_0006.JPG"
...
# path= r"D:\Jellybean\Relevant\jellybean_data-master\blueberry\DSC_0013.JPG"
# path = r"D:\Jellybean\Relevant\jellybean_data-master\buttered_popcorn\DSC_0011.JPG"
def mask_for_beans_dark(path, resize_factor = 1):
    ...
    # dictionary = dict(zip([0,1,2], len_catch))
    ...
    for i in range(1,np.max(markers)):
        ...
        # iterate over the list
            for mask in mask_comb:
                ...
                th2 = flood_fill(mask, (0, 0),255)
                th2 = flood_fill(th2, (0, mask.shape[1]-1),255)
                th2 = flood_fill(th2, (mask.shape[0]-1, 0),255)
                th2 = flood_fill(th2, (mask.shape[0]-1, mask.shape[1]-1),255)
                mask = th2.copy()
    ...
    # cnts = imutils.grab_contours(contours_temp)
            ...
            for i in  contours_temp:   
                cnt_scaled = scale_contour(i, resize_factor )
            # mask_draw = np.zeros(req_mask.shape, np.uint8)
        ...
        # to hopefully remove the shadow
            ...
            img_mask_col_ns = flood_fill(img_mask_col_ns, (0, 0,0),0)
    ...
    # get the mask first
        ...
        # file_sub = "D:\\Jellybean\\Relevant\\Test_Images\\" + name + "_"  + str(counter) + ".png"
        # visualize
...
# path = r"D:\Jellybean\Relevant\jellybean_data-master\bubble_gum\DSC_0034.JPG"
    
# mask_for_beans_dark(path, 0.8)    