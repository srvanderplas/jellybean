...
result = Parallel(n_jobs=7, verbose = 10)(delayed(fj.k_means_cluster)(i, n_clusters = 3) for i in paths)
df_beans = pd.DataFrame(result)
df_beans.to_csv("kmeans_rgb_features.csv", index = False)

# color features - kmeans - hsv
result = Parallel(n_jobs=7, verbose = 10)(delayed(fj.k_means_cluster)(i, type_img = "HSV",n_clusters = 3)
                     for i in paths)
df_beans = pd.DataFrame(result)
...
# k = 2
# color features - kmeans - rgb
result = Parallel(n_jobs=6, verbose = 10)(delayed(fj.k_means_cluster)(i, n_clusters = 2) for i in paths)
df_beans = pd.DataFrame(result)
df_beans.to_csv("kmeans_rgb_features.csv", index = False)

# color features - kmeans - hsv
result = Parallel(n_jobs=6, verbose = 10)(delayed(fj.k_means_cluster)(i, type_img = "HSV",n_clusters = 2)
                     for i in paths)
df_beans = pd.DataFrame(result)
df_beans.to_csv("kmeans_hsv_features.csv", index = False)
...
# k = 3
# color features - kmeans - rgb
result = Parallel(n_jobs=6, verbose = 10)(delayed(fj.k_means_cluster)(i, n_clusters = 3) for i in paths)
df_beans = pd.DataFrame(result)
df_beans.to_csv("kmeans_rgb_features.csv", index = False)

# color features - kmeans - hsv
result = Parallel(n_jobs=6, verbose = 10)(delayed(fj.k_means_cluster)(i, type_img = "HSV",n_clusters = 3)
                     for i in paths)
df_beans = pd.DataFrame(result)
df_beans.to_csv("kmeans_hsv_features.csv", index = False)
